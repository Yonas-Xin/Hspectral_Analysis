...
def mineral_classification(input_tif, output_tif):
    ...
    try:
        ...
        print(f"成功识别像元总数：{np.sum(calcite_mask)}")
        # ===================== 输出结果 =====================
        ...
        out_band.WriteArray(calcite_mask)
...
output_tif = r"c:\Users\85002\OneDrive - cugb.edu.cn\Word\小组项目\240922张川-铀矿探测\zy_kuangwu\predict_calcite.tif"  # 替换为实际路径
