...
from cnn_model.Models.Models import MODEL_DICT, SRACN, Shallow_1DCNN, Shallow_3DCNN
...
if __name__ == '__main__':
    ...
    config_name = "SRACN-spectral0.5_band0_noise0.5_s50_Emd128" # 配置名称
    out_classes = 8 # 分类数
    epochs = 100 # epoch
    batch = 12 # batch
    init_lr = 1e-4  # lr
    min_lr = 1e-7  # 最低学习率
    pretrain_pth = None
    train_images_dir = r'C:\Users\85002\OneDrive\文档\小论文\dataset\dataset50_img\.datasets.txt'  # 训练数据集
    test_images_dir = r'C:\Users\85002\OneDrive\文档\小论文\dataset\dataset100_img\.datasets.txt'  # 测试数据集
    ...
    model = Shallow_3DCNN(out_classes=out_classes, out_embedding=out_embedding, in_shape=train_dataset.data_shape)  # 模型实例化
    ...
    frame = Cnn_Model_Frame(model_name=config_name, 
                            epochs=epochs, 
                            min_lr=min_lr,
                            device=device, 
