...
if __name__ == "__main__":
    ...
    input_dir = r"d:\Data\Hgy\龚鑫涛试验数据\program_data\cluster\research_GF5_samples_2" # 裁剪shp文件夹
    dir_name = r'd:\Data\Hgy\龚鑫涛试验数据\program_data\handle_class\clip_data_15classs_1x1' # 设置一个目录存放裁剪的数据

    img.init(area_data)
    img.sampling_position = img.create_mask_from_mutivector(input_dir) # 指定sampling_position
