...
model_path = r'contrastive_learning\_results\Common_1DCNN_Test_Emb128_202509161545\Common_1DCNN_Test_Emb128_202509161545_best_encoder.pt'
...
out_put_path = r'C:\Users\85002\Desktop\TempDIR\embeddings2.csv' # csv 文件保存编码
FUNC = "PCA" # Deep_Learning PCA MNF

patch_size = 17 # 深度学习方法用
batch_size = 24 # 深度学习方法用
embedding_dims = 24 # 降维方法用
if __name__ == '__main__':
    if FUNC == "Deep_Learning":
        device = torch.device('cuda')
        dataset = DynamicCropDataset(input_img, input_shp, patch_size=patch_size)
    ...
    save_matrix_to_csv(out_embeddings, out_put_path)