...
if __name__ == '__main__':
    ...
    model = Moco3D(out_embedding=out_embedding, in_shape=dataset.data_shape, K=1024)  # 模型实例化
    ...
    augment = HighDimBatchAugment(spectral_mask_prob=0.5, band_dropout_prob=0)  # 数据特征转换
